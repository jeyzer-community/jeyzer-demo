...
public class FrozenStacksJob extends ExecutableJob {

	public FrozenStacksJob(ExecutableJobDefinition def) {
		super(def);
	}
	...
	@Function
	private void stuckCall() throws InterruptedException {
		hold();
	}
}
