...
public class FunctionPatternJob extends ExecutableJob {

	public FunctionPatternJob(ExecutableJobDefinition def) {
		super(def);
	}
	...
	@Function
	private void initModule() throws InterruptedException {
		hold();
	}
}
