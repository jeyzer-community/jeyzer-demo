...
public class FrozenStacksWithFunctionJob extends ExecutableJob {

	public FrozenStacksWithFunctionJob(ExecutableJobDefinition def) {
		super(def);
	}
	...
	@Function
	private void specificFastCriticalSection() throws InterruptedException {
		hold();
	}
}
