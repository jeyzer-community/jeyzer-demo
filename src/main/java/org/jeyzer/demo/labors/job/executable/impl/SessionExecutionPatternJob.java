...
public class SessionExecutionPatternJob extends ExecutableJob {

	public SessionExecutionPatternJob(ExecutableJobDefinition def) {
		super(def);
	}
	...
	@Function
	private void riskySection() throws InterruptedException {
		problematicSection();
	}
	
	@Operation
	private void problematicSection() throws InterruptedException {
		hold();
	}
}
