...
public class MemoryConsumingSystemJob extends ExecutableJob {
	
	private List<Long> elements = new ArrayList<>();

	public MemoryConsumingSystemJob(ExecutableJobDefinition def) {
		super(def);
	}
	...
	private void consumeMemory() throws InterruptedException {
		for (long i=1; i<12000000; i++){ //around 300 Mb
			this.elements.add(i);
		}
