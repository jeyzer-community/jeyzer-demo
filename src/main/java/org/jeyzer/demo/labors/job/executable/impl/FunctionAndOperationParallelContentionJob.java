...
public class FunctionAndOperationParallelContentionJob extends ExecutableJob {

	public FunctionAndOperationParallelContentionJob(ExecutableJobDefinition def) {
		super(def);
	}
	...
	@Function
	private void storeMessage() throws InterruptedException {
		jdbcConnectionPoolAccess();
	}

	@Function
	private void jdbcConnectionPoolAccess() throws InterruptedException {
		callRandomOperation();
	}

	@Operation
	private void waitForPoolResource() throws InterruptedException {
		oneTicHold();
	}
