...
public class LongRunningTaskJob extends ExecutableJob {

	public LongRunningTaskJob(ExecutableJobDefinition def) {
		super(def);
	}
	...
	@Function
	private void longRunningActivity() throws InterruptedException{
