...
public class FunctionPresenceJob extends ExecutableJob {

	public FunctionPresenceJob(ExecutableJobDefinition def) {
		super(def);
	}
	...
	@Function
	private void deprecatedFunctionMethod() throws InterruptedException {
		hold();
	}
}
