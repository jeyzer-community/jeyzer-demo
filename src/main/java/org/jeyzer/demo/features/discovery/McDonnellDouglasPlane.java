...
public class McDonnellDouglasPlane extends Feature {
	...
	private void transit() throws InterruptedException {
		log("McDonnellDouglasPlane", "starts");
		hold(); 
		log("McDonnellDouglasPlane", "ends");
	}
