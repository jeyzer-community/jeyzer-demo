...
JAVA_OPTS="-Dcom.sun.management.jmxremote -Dcom.sun.management.jmxremote.port=$JMX_PORT -Dcom.sun.management.jmxremote.ssl=false -Dcom.sun.management.jmxremote.authenticate=false -Duser.timezone=US/Pacific"
export JAVA_OPTS
...
DEMO_AGENT_PROFILE=demo-features-mx
#DEMO_AGENT_PROFILE=demo-features
...
$JAVA_HOME/bin/java $JEYZER_AGENT $JFR_OPTS $JEYZER_PUBLISH_PARAMS $JAVA_OPTS $MODULE_PATH -cp $CLASSPATH org.jeyzer.demo.features.FeatureDemo
