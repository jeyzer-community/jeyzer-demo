...
rem Possible scenario : random, solution, lock, demo (=solution, random x 2, deadlock)
set SCENARIO=demo
...
color 1E
title=Jeyzer Demo Philosophers
mode 135,3000
...
call "%JAVA_HOME%\bin\java.exe" %JEYZER_AGENT% %JAVA_OPTS% -cp %CLASSPATH% org.jeyzer.demo.philosopher2.PhilosophersDemo type=%SCENARIO%
goto end
