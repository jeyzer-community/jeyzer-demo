...
set JEYZER_TARGET_PROFILE=demo-features

rem The application node name
set JEYZER_TARGET_NAME=Demo-features instance

rem The issue description
set JEYZER_TARGET_DESCRIPTION=All the Jeyzer analysis features get applied here on a demo application

rem The Jeyzer record directory
set JEYZER_RECORD_DIRECTORY=${jeyzer.recorder.work.dir}\%JEYZER_TARGET_PROFILE%-mx
