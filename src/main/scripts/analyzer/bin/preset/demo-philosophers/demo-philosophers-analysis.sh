...
# The target profile
JEYZER_TARGET_PROFILE="demo-philosophers"
export JEYZER_TARGET_PROFILE

# The application node name
JEYZER_TARGET_NAME="Demo-philosophers instance"
export JEYZER_TARGET_NAME

# The issue description
JEYZER_TARGET_DESCRIPTION="Jeyzer analysis features get applied on the academic philosophers lock exercise"
