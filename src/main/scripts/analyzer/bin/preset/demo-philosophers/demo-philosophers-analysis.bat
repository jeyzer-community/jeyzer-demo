...
set JEYZER_TARGET_PROFILE=demo-philosophers

rem The application node name
set JEYZER_TARGET_NAME=Demo-Philosophers instance

rem The issue description
set JEYZER_TARGET_DESCRIPTION=Jeyzer analysis features get applied on the academic philosophers lock exercise
