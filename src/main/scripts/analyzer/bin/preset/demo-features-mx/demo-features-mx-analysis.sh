...
# The target profile
JEYZER_TARGET_PROFILE="demo-features"
export JEYZER_TARGET_PROFILE

# The application node name
JEYZER_TARGET_NAME="Demo-features instance"
export JEYZER_TARGET_NAME

# The issue description
JEYZER_TARGET_DESCRIPTION="All the Jeyzer analysis features, including the MX ones, get applied here on a demo application"
export JEYZER_TARGET_DESCRIPTION

# The Jeyzer record directory
JEYZER_RECORD_DIRECTORY=%{jeyzer.recorder.work.dir}/"$JEYZER_TARGET_PROFILE"-mx
